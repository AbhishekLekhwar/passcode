...
const Manager = () => {
  ...
  return (
    <div className='flex flex-col bg-pink-100 min-h-screen p-4 mx-0 sm:mx-16 sm:px-8 md:px-16 lg:px-24'>
      <div className='flex flex-col mt-8'>
        <div className='mx-auto p-4 flex items-center gap-3 flex-wrap'>
          ...
          <input 
            ...
            name='userName' 
            className='border-2 border-purple-300 p-2 m-2 rounded-2xl w-full' 
          ...
          <div className="relative w-full">
            <input 
              ...
              className='border-2 border-purple-300 p-2 rounded-2xl w-full pr-10' 
          ...
          <button 
            ...
            className='bg-purple-300 p-2 m-2 border-2 border-blue-400 rounded-2xl hover:text-white hover:bg-green-400 hover:border-white flex items-center gap-2'
          >
        ...
        <table className='min-w-full border-collapse  border-2 border-black'>
          <thead>
            <tr className='border-2 border-black'>
              <th className='border border-black p-2 text-center'>Site</th>
              ...
              <tr key={index}>
                ...
                <td className='border border-black p-2 text-center'>
                  ...
                  <button 
                    ...
                    className='bg-green-300 p-1 rounded ml-2'
                  >
                    <IoMdCopy />
                  </button>
                </td>
                ...
                <td className='border border-black p-2 text-center'>
                  <button 
                    ...
                    className='bg-blue-300 px-4 py-1 m-1 border border-blue-400 rounded-2xl'
                  >
                    Edit
                  </button>
                  <button 
                    onClick={() => handleDelete(index)} 
                    className='bg-red-300 p-1 rounded-2xl border border-red-400 ml-2'
                  >
                    Delete
                  </button>
                </td>
